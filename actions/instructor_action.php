...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (!empty($id)) {
        ...
        if ($stmt) {
            $stmt->bind_param("ssssssi", $first_name, $last_name, $phone, $email, $lab_assigned, $course, $id);
        ...
        if ($stmt) {
            $stmt->bind_param("ssssss", $first_name, $last_name, $phone, $email, $lab_assigned, $course);
